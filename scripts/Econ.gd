...
# Zoning costs
const LIGHT_BULDING_CODE_COST = 80
const MEDIUM_BULDING_CODE_COST = 100
const HIGH_BULDING_CODE_COST = 120
const SINGLE_FAMILY_ZONE_COST = 100
const MULTI_FAMILY_ZONE_COST = 150
const COMMERCIAL_ZONE_COST = 120
